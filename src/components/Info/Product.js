...
import NextGreen from "../../../src/assets/img/green/next.png";
import PrevGreen from "../../../src/assets/img/green/prev.png";
  ...
  return (
    <>
      ...
      <section className="p-8 mx-auto container hidden md:block">
        ...
        <h1 className="h3-2 text-green-500 text-center">Trị Mụn</h1>
        <div>
          <Slider {...settings}>
      ...
      <section className="p-8 mx-auto container hidden md:block">
        ...
        <h1 className="h3-2 text-green-500 text-center">Làn Da Lão Hóa</h1>
        <div>
          <Slider {...settings}>
            {productInfoData.map((item, index) => (
      ...
      <section className="block md:hidden">
        ...
        <h1 className="h3-2 text-green-500 text-center mb-5">Làn Da Lão Hóa</h1>
        <div>
          <Slider {...settings}>
            {productInfoData.map((item, index) => (
              // dùng flex chia 2 cột
